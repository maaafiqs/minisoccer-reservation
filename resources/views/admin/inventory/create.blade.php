                ...
                <form action="{{ route('admin.inventory.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="item_code" id="item_code" value="{{ old('item_code') }}" class="mt-1 block w-full rounded-xl border-gray-300 focus:border-green-500 focus:ring-green-500 shadow-sm" required placeholder="Contoh: BL-001">
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" class="mt-1 block w-full rounded-xl border-gray-300 focus:border-green-500 focus:ring-green-500 shadow-sm" required placeholder="Contoh: Bola Sepak Ukuran 5">
                        </div>

                        <!-- Brand -->
                        <div>
                            <label for="brand" class="block text-sm font-bold text-gray-700 mb-1">Merk (Opsional)</label>
                            <input type="text" name="brand" id="brand" value="{{ old('brand') }}" class="mt-1 block w-full rounded-xl border-gray-300 focus:border-green-500 focus:ring-green-500 shadow-sm" placeholder="Contoh: Adidas">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="quantity" id="quantity" value="{{ old('quantity', 0) }}" min="0" class="mt-1 block w-full rounded-xl border-gray-300 focus:border-green-500 focus:ring-green-500 shadow-sm" required>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-2 flex space-x-6">
                                <label class="inline-flex items-center cursor-pointer">
                                    <input type="radio" name="status" value="baik" class="form-radio text-green-500 focus:ring-green-500 h-5 w-5" {{ old('status', 'baik') === 'baik' ? 'checked' : '' }}>
                                    <span class="ml-2 font-medium text-gray-700">Kondisi Baik</span>
                                </label>
                                <label class="inline-flex items-center cursor-pointer">
                                    <input type="radio" name="status" value="rusak" class="form-radio text-red-500 focus:ring-red-500 h-5 w-5" {{ old('status') === 'rusak' ? 'checked' : '' }}>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3" class="mt-1 block w-full rounded-xl border-gray-300 focus:border-green-500 focus:ring-green-500 shadow-sm">{{ old('description') }}</textarea>
                    </div>

                    <div class="flex justify-end pt-4 border-t border-gray-100">
                        <button type="submit" class="bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-8 rounded-xl shadow-md transition-all duration-300">
                            Simpan Barang
                        </button>
                    </div>
                </form>
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('inventoryForm', () => ({
                ...
                selectedCategory: "{{ old('inventory_category_id') }}",
